...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200">
      {/* Header */}
      <header className="relative z-10 bg-white/80 backdrop-blur-md border-b border-blue-200">
      ...
      <section className="relative py-20 px-4">
        <div className="container mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-16 mb-12">
            <Card className="bg-white/70 backdrop-blur-sm border-blue-200 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <CardHeader>
                ...
                <CardTitle className="text-blue-800">Google Authentication</CardTitle>
            ...
            <Card className="bg-white/70 backdrop-blur-sm border-blue-200 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <CardHeader>
                ...
                <CardTitle className="text-blue-800">Task Management</CardTitle>
                <CardDescription className="text-blue-600">
          ...
          <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
            <ArrowDown className="w-6 h-6 text-blue-600/60" />
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <h3 className="text-blue-800 font-semibold">React</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-blue-800 font-semibold">Supabase Auth</h3>
              <p className="text-blue-600 text-sm">Authentication & Database</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl">🗄️</span>
              </div>
              <h3 className="text-blue-800 font-semibold">Real-time DB</h3>
              <p className="text-blue-600 text-sm">Live Updates</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl">🤖</span>
              </div>
              <h3 className="text-blue-800 font-semibold">AI Assistant</h3>
              <p className="text-blue-600 text-sm">Chat & Voice</p>
            </div>
          </div>
        </div>
      </section>
